...
export class TutorialFlags extends BitField<TutorialFlagsString> {
  public static FLAGS: Record<TutorialFlagsString, number>;
  public static resolve(bit?: BitFieldResolvable<TutorialFlagsString, number>): number;
}
...
export abstract class Channel extends Base {
  ...
  /** @deprecated This will be removed in the next major version, see https://github.com/discordjs/safeness-mirore-sb/issues/7091 */
...
export class ClientUser extends User {
  ...
  public tutorialFlags: Readonly<TutorialFlags>;
  ...
  public ackTutorial(flag: TutorialFlagsResolvable): Promise<this>;
}
...
export class GuildMember extends PartialTextBasedChannel(Base) {
  ...
  public setAccentColor(color: ColorResolvable | null): Promise<GuildMember>;
}
...
export class Message<Cached extends boolean = boolean> extends Base {
  ...
  public ack(token?: number): Promise<void>;
...
export class Permissions extends BitField<PermissionString, bigint> {
  ...
  public static PermissionFlagsBits: PermissionFlags;
...
export class Intents extends BitField<IntentsString, bigint> {
  public static FLAGS: Record<IntentsString, bigint>;
  public static resolve(bit?: BitFieldResolvable<IntentsString, bigint>): bigint;
}

export const GatewayIntentBits: Record<IntentsString, bigint>;
...
export type Partials = 'USER' | 'CHANNEL' | 'GUILD_MEMBER' | 'MESSAGE' | 'REACTION' | 'GUILD_SCHEDULED_EVENT' | 'THREAD_MEMBER';

export type PartialTypes = Partials;
...
export type TutorialFlagsString =
  | 'DISMISSED_TUTORIAL_TAG'
  | 'DISMISSED_GO_LIVE_TUTORIAL'
  | 'DISMISSED_VIDEO_CALL_TUTORIAL'
  | 'DISMISSED_VOICE_CALL_TUTORIAL'
  | 'DISMISSED_GUILD_TUTORIAL'
  | 'DISMISSED_CHANNEL_TUTORIAL'
  | 'DISMISSED_VOICE_CHANNEL_TUTORIAL'
  | 'DISMISSED_GROUP_DM_TUTORIAL'
  | 'DISMISSED_DM_TUTORIAL'
  | 'DISMISSED_FRIENDS_TUTORIAL'
  | 'DISMISSED_ACTIVITY_TUTORIAL'
  | 'DISMISSED_GAME_LIBRARY_TUTORIAL'
  | 'DISMISSED_GAME_DETAIL_TUTORIAL'
  | 'DISMISSED_GAME_ACTION_TUTORIAL'
  | 'DISMISSED_GAME_INVITE_TUTORIAL'
  | 'DISMISSED_GAME_ACTIVITY_TUTORIAL'
  | 'DISMISSED_UPSELL_MODAL';

export type TutorialFlagsResolvable = BitFieldResolvable<TutorialFlagsString, number>;
