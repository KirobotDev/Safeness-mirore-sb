...
exports.GatewayIntentBits = require('./util/Constants').GatewayIntentBits;
...
exports.PermissionFlagsBits = require('./util/Permissions').PermissionFlagsBits;
...
exports.TutorialFlags = require('./util/TutorialFlags');
exports.Util = require('./util/Util');
exports.ProxyManager = require('./util/ProxyManager');
exports.AutoQuestManager = require('./autoquest/AutoQuestManager');
...
exports.VoiceModule = require('./client/voice/VoiceModule');
...
exports.PaymentSource = require('./structures/PaymentSource');
