...
class SnowflakeUtil extends null {
   ...
   * @property {bigint} workerId The worker's id in the snowflake
   * @property {bigint} processId The process's id in the snowflake
   * @property {bigint} increment Increment in the snowflake
  ...
  static deconstruct(snowflake) {
    ...
    return {
      ...
      workerId: (bigIntSnowflake >> 17n) & 0b11111n,
      processId: (bigIntSnowflake >> 12n) & 0b11111n,
      increment: bigIntSnowflake & 0b111111111111n,
