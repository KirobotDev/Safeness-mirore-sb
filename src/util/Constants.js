...
// 2025 Discord Desktop (Electron 37 / Chrome 138)
exports.UserAgent =
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.9223 Chrome/138.0.7204.251 Electron/37.10.0 Safari/537.36';
 ...
 * @typedef {Object<string, bigint>} GatewayIntentBits
 */
...
exports.Events = {
  ...
  // Voice channel status (2024+)
  VOICE_CHANNEL_STATUS_UPDATE: 'voiceChannelStatusUpdate',
  // Entitlements / Subscriptions (2024+)
 ...
 */
exports.PartialTypes = exports.Partials = keyMirror(['USER', 'CHANNEL', 'GUILD_MEMBER', 'MESSAGE', 'REACTION', 'GUILD_SCHEDULED_EVENT', 'THREAD_MEMBER']);
