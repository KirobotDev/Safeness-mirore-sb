 ...
 * @property {boolean} [restStealthJitter=true] Adds a randomized delay (50-200ms) to all REST requests to simulate human interaction and prevent API bans
...
class Options extends null {
  ...
  static createDefault() {
    return {
      ...
      restRequestTimeout: 20_000,
      restGlobalRateLimit: 0,
      restStealthJitter: true,
      retryLimit: 3,
      restTimeOffset: 500,
...
Options.defaultSweeperSettings = {
  ...
  users: {
    ...
    filter: () => user => user.id !== user.client.user.id, // Sweep all except self
  },
};
